...
exports.insertPtk = (response, statement, data) => {
...
exports.getPtk = (response, statement) => {
      // running querys
...
exports.getPtkId = (res, statement, id) => {
      // running querys
...
exports.updatePtk = (response, searchStatement, updateStatement, id, data) => {
...
exports.deletePtk = (response, searchStatement, deleteStatement, id) => {
