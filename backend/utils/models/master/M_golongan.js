...
exports.insertGolongan = (response, statement, data) => {
...
exports.getGolongan = (response, statement) => {
      // running querys
...
exports.getGolonganId = (res, statement, id) => {
      // running querys
...
exports.updateGolongan = (response, searchStatement, updateStatement, id, data) => {
...
exports.deleteGolongan = (response, searchStatement, deleteStatement, id) => {
