...
exports.insertKelas = (response, statement, data) => {
...
exports.getKelas = (response, statement) => {
      // running querys
...
exports.getKelasId = (res, statement, id) => {
      // running querys
...
exports.updateKelas = (response, searchStatement, updateStatement, id, data) => {
...
exports.deleteKelas = (response, searchStatement, deleteStatement, id) => {
