...
exports.getKurikulum = (response, statement) => {
      // running querys
...
exports.getKurikulumId = (res, statement, id) => {
      // running querys
...
exports.updateKurikulum = (response, searchStatement, updateStatement, id, data) => {
...
exports.deleteKurikulum = (response, searchStatement, deleteStatement, id) => {
