...
exports.insertGedung = (response, statement, data) => {
...
exports.getGedung = (response, statement) => {
      // running querys
...
exports.getGedungId = (res, statement, id) => {
      // running querys
...
exports.updateGedung = (response, searchStatement, updateStatement, id, data) => {
...
exports.deleteGedung = (response, searchStatement, deleteStatement, id) => {
