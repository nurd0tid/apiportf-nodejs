...
exports.insertKepegawaian = (response, statement, data) => {
...
exports.getKepegawaian = (response, statement) => {
      // running querys
...
exports.getKepegawaianId = (res, statement, id) => {
      // running querys
...
exports.updateKepegawaian = (response, searchStatement, updateStatement, id, data) => {
...
exports.deleteKepegawaian = (response, searchStatement, deleteStatement, id) => {
