...
exports.insertMapel = (response, statement, data) => {
...
exports.getMapel = (response, statement) => {
      // running querys
...
exports.getMapelId = (res, statement, id) => {
      // running querys
...
exports.updateMapel = (response, searchStatement, updateStatement, id, data) => {
...
exports.deleteMapel = (response, searchStatement, deleteStatement, id) => {
