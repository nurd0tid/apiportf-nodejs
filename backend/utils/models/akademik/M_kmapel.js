...
exports.insertKmapel = (response, statement, data) => {
...
exports.getKmapel = (response, statement) => {
      // running querys
...
exports.getKmapelId = (res, statement, id) => {
      // running querys
...
exports.updateKmapel = (response, searchStatement, updateStatement, id, data) => {
...
exports.deleteKmapel = (response, searchStatement, deleteStatement, id) => {
